...
function wpsp_control_order( $butterbean, $post_type ) {
	...
	$manager->get_control( 'wpsp_googleplus' )->priority = 40;
	$manager->get_control( 'wpsp_googleplus_color' )->priority = 45;
	$manager->get_control( 'wpsp_googleplus_color_hover' )->priority = 46;
						...
						<div class="postbox wpsp-metabox" id="gen-1" style="width:50%;">
							...
							<div class="inside">
								...
								<p>
									...
									<a class="button button-primary" href="<?php echo esc_url( 'https://wpshowposts.com/documentation' ); ?>" target="_blank"><?php _e('Documentation','wp-show-posts-pro');?></a>  
								</p>
							</div>
						</div>
...
function wpsp_process_license_key()
{
	...
	if( isset( $_POST[ 'wp_show_posts_update_license_key' ] ) ) {
		...
		update_option( 'wp_show_posts_license', $new );
